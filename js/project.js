...
var instanote = [{
	...
	"summary": "Instanote attaches captions, tags, and locations to your photos providing a robust tool for creating, editing, and searching your memories.",
 	"technicalDetails": ["Swift 3.0", "Core Data Infrastructure", "Custom Camera", "Custom Table Cells", "Map Kit Integration"],
...
var matchpop = [{
	...
	"summary": "A classic card matching game brought to life with imagery, animations, and sounds. Match all of the cards to play a surprise balloon popping game!",
 	"technicalDetails": ["Swift 3.0", "AVFoundation", "NSUserDefaults"],
...
var graph = [{
	...
	"summary": "Graph mimics the essentials of a scientific calculator by computing basic operations while displaying the results on an x-y axis.",
 	"technicalDetails": ["Swift 3.0", "SplitViewController", "UIBezierPath"],
...
var tetrafire = [{
	...
	"summary": "Stack blocks, complete lines, and stop fires, Tetra Fire adds a new puzzle-solving challenge to the classic game. Float through space with amazing stock photography provided by NASA. Enjoy amazing effects powered by particle animations, sounds, and vibrations.",
 	"technicalDetails": ["Swift 3.0", "SpriteKit", "NSKeyedArchiver / NSCoding", "MVC"],
